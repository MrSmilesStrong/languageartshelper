...
class UIManager {
    ...
    update() {
        ...
        // Custom Night æ˜¾ç¤ºä¸º "7" æˆ– "CUSTOM"
    ...
    createControlPanelPopup() {
        ...
        option1.style.direction = 'ltr'; // å¼ºåˆ¶ä»Žå·¦åˆ°å³
        ...
        option1.addEventListener('click', () => {
            ...
            // ä¸åœ¨è¿™é‡Œç«‹å³æ›´æ–°ï¼Œç­‰toggleVentså®ŒæˆåŽä¼šè‡ªåŠ¨è°ƒç”¨updateControlPanelOptions
        });
        ...
        option2.style.direction = 'ltr'; // å¼ºåˆ¶ä»Žå·¦åˆ°å³
    ...
    selectControlOption(option) {
        ...
        if (option === 'vents') {
            ...
            // æ›´æ–°é€šé£Žå£æ–‡æœ¬ï¼ˆä¸åŒ…æ‹¬dots spanï¼‰
    ...
    updateControlPanelOptions() {
        ...
        this.updateCameraStatus();
        this.updateVentsStatus(); // æ·»åŠ é€šé£Žå£çŠ¶æ€æ›´æ–°
    }
    ...
    animateLoadingDots(element) {
        ...
        const animate = () => {
            ...
            // console.log('Dots animation:', states[index]); // è°ƒè¯•è¾“å‡º
    ...
    // Animate display (dots after button, ERR on right) - ä¸å†ä½¿ç”¨
    animateLoadingDotsWithERR(element) {
        // å·²åºŸå¼ƒï¼Œä½¿ç”¨ animateLoadingDots ä»£æ›¿
    }
    
    // Handle restart camera
    handleRestartCamera() {
        // å…è®¸åœ¨æ‘„åƒå¤´æ²¡æœ‰æ•…éšœæ—¶ä¹Ÿèƒ½é‡å¯ï¼ˆä½œä¸ºç­–ç•¥ä½¿ç”¨ï¼‰
    ...
    updateHotspotVisibility(viewPosition) {
        ...
        // console.log('ðŸ” updateHotspotVisibility - viewPosition:', viewPosition);
        ...
        if (cameraBtn) {
            ...
            // console.log('ðŸ“· Camera button - opacity:', cameraBtn.style.opacity, 'pointerEvents:', cameraBtn.style.pointerEvents);
        }
    }
